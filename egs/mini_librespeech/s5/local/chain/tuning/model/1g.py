...
class OrthonormalLinear(nn.Module):
    def __init__(self, feat_dim, out_dim, bias=True, scale=0.0,
        ...
        self.preconditioner_in = pkwrap.kaldi.nnet3.OnlineNaturalGradient()
        ...
        self.preconditioner_out = pkwrap.kaldi.nnet3.OnlineNaturalGradient()
    ...
    def forward(self, input):
        ...
        x =  pkwrap.chain.OnlineNaturalGradient.apply(
            input,
            self.weight,
            self.bias,
...
class TDNNFBatchNorm(nn.Module):
    def __init__(self, feat_dim, output_dim, context_len=1, subsampling_factor=1, orthornomal_constraint=0.0):
...
class Net(nn.Module):
    def __init__(self, output_dim, feat_dim):
        ...
        self.tdnn1 = TDNNFBatchNorm(feat_dim, 512, context_len=5, orthornomal_constraint=-1.0)
        self.tdnn2 = TDNNFBatchNorm(512, 512, context_len=3, orthornomal_constraint=-1.0)
        self.tdnn3 = TDNNFBatchNorm(512, 512, context_len=3, subsampling_factor=3, orthornomal_constraint=-1.0)
        self.tdnn4 = TDNNFBatchNorm(512, 512, context_len=3, orthornomal_constraint=-1.0)
        self.tdnn5 = TDNNFBatchNorm(512, 512, context_len=3, orthornomal_constraint=-1.0)
        self.tdnn6 = TDNNFBatchNorm(512, 512, context_len=3, orthornomal_constraint=-1.0)
        self.prefinal_chain = TDNNFBatchNorm(512, 512, context_len=1, orthornomal_constraint=-1.0)
        self.prefinal_xent = TDNNFBatchNorm(512, 512, context_len=1, orthornomal_constraint=-1.0)
