...
out_dir=decode_7k_${filename}_pytorch_qi8_1b
...
nj=50
# Quantize the model params and activations in Pytorch and run the forward pass in Pytorch
if [ $stage -le 1 ]; then
    ...
    python $DIR/local/chain/inference/run_tdnn_quant_torch.py \
